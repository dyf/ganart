...
from tensorflow.keras.layers import Conv2D, Conv2DTranspose, BatchNormalization, ReLU, LeakyReLU, Dropout, Input, Activation, ZeroPadding2D
...
def UNetUpScaleModel(levels=2):
    ...
    last = Conv2D(3, 4, padding='same', activation='tanh')
